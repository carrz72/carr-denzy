...
import { emptyLine, newKey, type DraftLine } from "@/lib/draft-lines";
...
/** Re-exported for the builders, which take draft lines as a prop. A type
 *  erases at build time, so this does not drag the client boundary with it. */
export type { DraftLine };

/** What actually goes to the server: parsed, ordered, ready for the database. */
